document.addEventListener("DOMContentLoaded", async () => {
  ...
  const PANEL_DEFAULTS = {
    ...
    ai: {
      fields: {
        ...
        "opt-deepseek-model": "deepseek-v4-flash", "opt-qwen-model": "qwen3.5-flash",
        "opt-minimax-model": "MiniMax-M2.7", "opt-openrouter-model": "meta-llama/llama-4-scout:free",
  ...
  async function saveAll() {
    const data = {
      ...
      qwenModel: $id("opt-qwen-model").value.trim() || "qwen3.5-flash",
      minimaxApiKey: obfuscateKey($id("opt-minimax-key").value.trim()),
      minimaxModel: $id("opt-minimax-model").value.trim() || "MiniMax-M2.7",
