...
- **Schnell- & Stapelspeicherung** — die Seite (oder als *später lesen*) direkt per Tastenkürzel speichern, ohne das Popup zu öffnen; oder alle offenen Tabs auf einmal sichern, mit KI-Tagging pro Tab, Live-Fortschritt und einem Tab-Set-Bündel; Offline-Entwürfe bleiben in einer lokalen Warteschlange und werden nach Wiederherstellung der Verbindung erneut in Pinboard gespeichert
