...
- **Страница в Markdown** — преобразуйте текущую страницу в чистый Markdown со встроенным предпросмотром (режимы рендеринга/исходника, оглавление, статистика чтения); копируйте или скачивайте как `.md` или стилизованный `.html`, настраивайте frontmatter, обработку изображений и включение оглавления либо по желанию экспортируйте в [Obsidian](https://obsidian.md); выберите [defuddle](https://github.com/kepano/defuddle) + [Turndown](https://github.com/mixmark-io/turndown) (локально) или [Jina Reader](https://jina.ai/reader) (облако)
