...
- **AI-метки и аннотации** — свой ключ для 13 популярных LLM-провайдеров или любого OpenAI-совместимого эндпоинта
...
- **Страница в Markdown** — преобразуйте текущую страницу в чистый Markdown — предпросмотр, копирование в буфер или скачивание `.md`. Выберите [defuddle](https://github.com/kepano/defuddle) + [Turndown](https://github.com/mixmark-io/turndown) (локально) или [Jina Reader](https://jina.ai/reader) (облако)
