...
- **當前頁轉 Markdown** — 將目前網頁轉為乾淨的 Markdown，可預覽、複製到剪貼簿，或下載為 `.md`。本機由 [defuddle](https://github.com/kepano/defuddle) + [Turndown](https://github.com/mixmark-io/turndown) 驅動，可選 [Jina Reader](https://jina.ai/reader) 雲端備援
- **9 種語言**、可自訂快捷鍵、零追蹤
