...
- **Page vers Markdown** — convertir la page courante en Markdown propre — aperçu, copie dans le presse-papier ou téléchargement en `.md`
...
4. Cliquez sur l'icône de la barre d'outils → collez votre [jeton API Pinboard](https://pinboard.in/settings/password) → enregistrez
