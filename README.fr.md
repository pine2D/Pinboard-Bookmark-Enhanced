...
- **Page vers Markdown** — convertit la page courante en Markdown épuré, avec un aperçu intégré (affichage rendu ou source, table des matières, statistiques de lecture) ; copiez-la ou téléchargez-la en `.md` ou en `.html` mis en forme, ajustez le frontmatter, le traitement des images et la table des matières, ou envoyez-la directement dans [Obsidian](https://obsidian.md). L'extraction adaptée à chaque site préserve la lisibilité des questions-réponses et des fils de discussion (Zhihu, Hacker News, Stack Overflow, …) ; à vous de choisir [defuddle](https://github.com/kepano/defuddle) + [Turndown](https://github.com/mixmark-io/turndown) (en local) ou [Jina Reader](https://jina.ai/reader) (dans le cloud)
- **Interroger et traduire la page** — depuis cet aperçu Markdown, posez vos questions et recevez des réponses diffusées en continu, assorties de citations vérifiées qui renvoient à la source ; faites expliquer sur place n'importe quel passage sélectionné, ou traduisez la page entière à l'aide d'un glossaire personnalisé, au choix en affichage original, bilingue ou traduit
